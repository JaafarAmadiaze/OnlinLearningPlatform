...
export const courses: Courses[] = [
  {id: 1, title: 'Angular', description: 'Angular is a platform and framework for building single-page client applications using HTML and TypeScript.', ImageUrl: 'https://angular.io/assets/images/logos/angular/angular.png', created_at: new Date(), duration: 30, course_id: 1, tags: ['Frontend'], price: 100 },
    ...
    {id : 9, title: 'Cyber Security', description: 'Cybersecurity is the practice of protecting systems, networks, and programs from digital attacks.', ImageUrl: 'https://www.security.org/wp-content/uploads/2020/06/Security-Logo.png', created_at: new Date(), duration: 30, course_id: 10 , tags: ['Security'], price: 190 },
    {id :10, title:'RedTeam', description: 'Red teaming is the practice of rigorously challenging an organization\'s plans, policies, systems and assumptions by applying an adversarial approach.', ImageUrl: 'https://www.security.org/wp-content/uploads/2020/06/Security-Logo.png', created_at: new Date(), duration: 30, course_id: 11 , tags: ['Security'], price: 200 },
    {id :11, title:'BlueTeam', description: 'Blue teaming is the practice of rigorously challenging an organization\'s plans, policies, systems and assumptions by applying an adversarial approach.', ImageUrl: 'https://www.pngitem.com/pimgs/m/12-125019_red-team-logo-hd-png-download.png', created_at: new Date(), duration: 30, course_id: 12 , tags: ['Security'], price: 210 },
];
